...
import javax.swing.tree.DefaultTreeCellRenderer;
 ...
 class TreeDEmo extends JPanel
    ...
    public TreeDEmo() {
        ...
        createNodes(top,Homework1.root);

        //Create a tree that allows one selection at a time.
        tree = new JTree(top);
        tree.getSelectionModel().setSelectionMode
                (TreeSelectionModel.SINGLE_TREE_SELECTION);
        ImageIcon Boom = new ImageIcon(TreeDEmo.class.getResource("middle.gif"));
        DefaultTreeCellRenderer renderer = new DefaultTreeCellRenderer();
        renderer.setClosedIcon(Boom);
        renderer.setOpenIcon(Boom);
    ...
    public void valueChanged(TreeSelectionEvent e) {
        ...
        Node Show = (Node)nodeInfo;
       // Homework1.infix(Show);
        if(Show.left != null || Show.right != null){

            htmlPane.setText("" + Homework1.calculate(Show));
            
        }else{
            htmlPane.setText(Show.c.toString());
        }
 /*       if (node == null) return;
